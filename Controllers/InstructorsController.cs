...
namespace M1Assignment1.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public InstructorsController(LocalDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstructorId,FirstName,LastName,EmailAddress,Course")] Instructor instructor)
        {
