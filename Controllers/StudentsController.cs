...
namespace M1Assignment1.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(LocalDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,EmailAddress,PhoneNumber,Course")] Student student)
        {
